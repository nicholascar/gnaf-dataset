...
URI_BASE = "http://linked.data.gov.au/dataset/gnaf-2016-05"  # must _not_ end in a trailing slash
...
SPARQL_QUERY_URI = 'http://10.0.0.5/fuseki/gnaf_2016_05/query'   #'http://13.210.68.240/fuseki/gnaf/query'
